...
| # | งาน | Owner | Sprint |
|---|---|---|---|
| 01 | Repo + Next.js scaffold | D | 0 |
| 02 | Supabase schema + RLS | D | 0 |
| 03 | Vercel deploy pipeline | D | 0 |
| 04 | Gemini spike + lib/ai skeleton | C | 0 |
| 05 | Wireframes 5 หน้าหลัก | A+B | 0 |
| 06 | Seed script demo account | D | 2 |
